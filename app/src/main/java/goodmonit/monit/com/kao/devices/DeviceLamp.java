...
public class DeviceLamp extends DeviceInfo {
    private static final String TAG = Configuration.BASE_TAG + "Lamp";
    ...
    private boolean isServerDirectConnected;

    public DeviceLamp(Context context) {
        super();
        mContext = context;
    ...
    public DeviceLamp(Context context, DeviceInfo info) {
    ...
    public void setConnectionState(int state) {
        if (state == DeviceConnectionState.DISCONNECTED || state == DeviceConnectionState.WIFI_CONNECTED || state == DeviceConnectionState.BLE_CONNECTED) {
