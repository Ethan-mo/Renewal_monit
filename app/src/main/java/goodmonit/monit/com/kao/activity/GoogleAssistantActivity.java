...
public class GoogleAssistantActivity extends BaseActivity {
    ...
    private Button btnLaunchAssistant, btnGetAuthKey;
    ...
    private void _setToolBar() {
        ...
        tvToolbarTitle.setText(getString(R.string.assistant_title));
    }
    ...
    private void _initView() {
        ...
        btnLaunchAssistant = (Button)findViewById(R.id.btn_nugu_launch_app);
        btnLaunchAssistant.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://assistant.google.com/services/invoke/uid/00000058d7533117?intent=actions.intent.MAIN")));

//                PackageInfo pi = null;
//                try {
//                    pi = mContext.getPackageManager().getPackageInfo("com.google.android.apps.googleassistant", 0);
//                } catch (PackageManager.NameNotFoundException e) { // 마켓으로 이동
//                    if (DBG) Log.e(TAG, "Assistant not found");
//                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=" + "com.google.android.apps.googleassistant")));
//                }
//                if (pi != null) { // 앱이 설치되어 있으면 실행
