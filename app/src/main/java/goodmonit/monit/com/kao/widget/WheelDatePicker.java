...
public class WheelDatePicker extends LinearLayout {
	private static final String TAG = Configuration.BASE_TAG + "WheelDatePicker";
	...
	private void _initView() {
		...
		wvYear = (WheelView) mView.findViewById(R.id.wv_widget_wheel_date_picker_item1);
		...
		wvMonth = (WheelView) mView.findViewById(R.id.wv_widget_wheel_date_picker_item2);
		...
		wvDay = (WheelView) mView.findViewById(R.id.wv_widget_wheel_date_picker_item3);
