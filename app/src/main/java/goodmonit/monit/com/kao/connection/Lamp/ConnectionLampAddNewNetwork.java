...
public class ConnectionLampAddNewNetwork extends BaseFragment {
    private static final String TAG = Configuration.BASE_TAG + "LampAddNetwork";
	...
	private void _initView(View v) {
		...
		rctnSecurityType.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				_hideKeyboard();
				((ConnectionActivity) mMainActivity).showFragment(ConnectionActivity.STEP_LAMP_SELECT_SECURITY);
			}
		});
