...
public class WidgetProvider2x3 extends WidgetProvider {
    private static final String TAG = Configuration.BASE_TAG + "Widget2x3";
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i = 0; i < cntWidgetId; i++) {
            ...
            RemoteViews views = widgetMgr.buildViews(appWidgetId, 3, false);
